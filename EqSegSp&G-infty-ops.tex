...
Moreover, since one can forget the $G$-action when verifying this condition \cite[Rem. 6.7]{Per18}, we will usually call these simply \textit{normal monomorphisms}.
