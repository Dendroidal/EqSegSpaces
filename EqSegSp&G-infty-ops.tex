...
and the maps labeled $\sim$ are trivial Kan fibrations
...
\begin{remark}
	...
	\end{tikzcd}
\end{equation}
such that the maps labeled $+$ are in $\mathbb{R}^+$,
maps labeled $-$ are in $\mathbb{R}^-$,
...
It thus follows that the maps labeled $\sim$ in
...
It follows that the maps labeled $\sim$ in
\[
\begin{tikzcd}[row sep=10]
	X_r \ar[->>]{r}&
