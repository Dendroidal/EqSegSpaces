...
and our narrative has been modified to highlight this\footnote{
  The literal equivariant statement for \cite[Thm. 6.6]{CM13a} can be found in Remark \ref{INTERP REM}.}.
...
\todo[inline]{i don't think this is quite referring to Thm. 6.6}
...
\begin{remark}
	...
	\Omega_G$,
        ...
        formed by % the homotopy categories
	\[
...
\begin{remark}\label{INTERP REM}
      ...
      this is immediate from Corollary \ref{JOINTFIBCHAR COR}(iii).
\end{remark}
