...
\begin{inparaenum}
	...
	\item[(iii)] lastly, \cite{CM13b} established the existence of the model structure on $\mathsf{sOp}$ as well as the Quillen equivalence between $\mathsf{sOp}$ and $\mathsf{PreOp}$, finishing the proof of the main result of the program.\footnote{
                This narrative is itself a generalization of the interactions between the various models for $(\infty,1)$-categories, including complete Segal spaces and Segal categories. A survey of such models can be found at e.g. \cite{Ber10}.}
\end{inparaenum}
