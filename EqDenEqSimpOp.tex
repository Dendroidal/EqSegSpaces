...
\section{Complete equivariant dendroidal Segal spaces}

{\color{red} HERE}


\subsection{Joint left Bousfield localizations}

The results in \cite[\S 4]{CM13a}
concerning the simplicial Reedy model structure all generalize mutatis mutandis.
