...
\begin{proof}
      ...
      $B \subseteq B'$ are $G$-closed $G$-concave subposets of faces
      $U_0 \in \Lambda^{G e}[T] \setminus \Lambda^{G e}_o[T]$
      such that $\mathrm{Stab}_H(r(U_0)) e \subseteq U_0$. 
      \todo[inline]{this obviously is not correct as stated - in particular, the last case at the very bottom fails miserably.}
