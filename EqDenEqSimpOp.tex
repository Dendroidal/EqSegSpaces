...
\begin{example}
	...
	By contrast, $\Lambda^{Gb}[T]$ lacks only the boxed faces (which are precisely those faces in the picture below that are \textit{inner} faces of $T$).
...
\begin{definition}
	Two maps $f,f'\colon X \rightrightarrows Y$ between dendroidal Segal spaces are called $J$-homotopic, written $f \sim_J f'$, if
