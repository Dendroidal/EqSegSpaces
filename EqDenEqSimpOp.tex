...
\begin{definition}
      ...
      $\Phi^{Ge}(T) = \Phi(T) \setminus (T_0 \setminus He)$.
...
\begin{definition}
      ...
      Given an inner edge $e \in T$, let
      $\Phi_{\mathrm{Orb}}^{Ge}(T) := \Phi_{o}(T) \setminus (T_0\setminus He)$
...
\begin{definition}
      ...
      an edge $e \in U_0$.
      We say that $H e \subseteq U_0$ is a \textit{characteristic edge orbit} of
...
\begin{proposition}
      ...
      $H e$ is a characteristic edge orbit of $X \subseteq \Omega[T] \supseteq \Omega[G \cdot U]$
...
\begin{proof}
      ...
      $C \subseteq C'$ $K$-closed concave subsets of $\Phi_{\mathrm{Inn}}^{H e}(U_0) \setminus X$, the map
      \begin{equation}
      ...
      \end{equation}
      is inner $G$-anodyne.
      Indeed, once $C = \Phi_{\mathrm{Inn}}^{H e}(U_0) \setminus X$, we have the pushout
      \begin{equation}
            \begin{tikzcd}
                  G \cdot_K \left( \Lambda^{H e}[U_0] \right) \arrow[d] \arrow[r]
                  &
                  X \cup G \cdot_K \left( \bigcup\limits_{E \in \Phi_{\mathrm{Inn}}^{H e}(U_0)} \Omega[U_0 \setminus E] \arrow[d] \right)
                  \\
...
\begin{lemma}
      ...
      Then $H e$ is a characteristic edge orbit for $\Lambda_0^{Ge}[T] \subseteq \Omega[T] \supseteq[G \cdot U_0]$.
\end{lemma}
\begin{proof}
      ...
      Thus, in these cases, $H e$ is a characteristic edge orbit vacuously.
...
\begin{proof}
      ...
      $H e$ is a characteristic edge orbit for the domain relative to $\Omega[T] \supseteq \Omega[G \cdot U_0]$.
