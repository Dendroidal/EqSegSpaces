...
\end{equation} 
We note that any $T \in \Omega_G$ can be written $(G \cdot T_{\**})/\Gamma$, where $T_{\**}$ is a component of $T$ and
...
\begin{proof}
      Since $\Omega(T)$ is the free coloured operad on its vertices, we have that
      \begin{equation}
