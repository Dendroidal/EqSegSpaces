...
non-empty $G$-equivariant set of inner edges 
...
$\Xi_{\bar{V}} = \emptyset$.
Hence just as before $G\bar{V}$ is an equivariant outer face other than $T$, hence $V$ is in $X=\Lambda_o^{E}[T]$.
...
and 
$rp = qg =  r H g$
it follows that both $p$ and $rH$ are lifts for the top square in the right diagram, so that by the uniqueness assumption it is
$p = rH$. This shows that $H$ is indeed a lift for the left square.
