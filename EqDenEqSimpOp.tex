...
\begin{proof}
      ...
      Furthermore, it then suffices to show that
      $H e$ is a characteristic edge set for $T_0$ with respect to $A$,
      where $e \in T_0$ and $T \simeq G \cdot_H T_0$ is a decomposition for $T$.
      \begin{enumerate}
      \item Condition (i) is immediate.
      \item Condition (ii) follows as $\partial^{out}\Omega[T] \subseteq A$.
      \item Condition (iii)
