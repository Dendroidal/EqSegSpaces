...
(planar degeneracies are characterized in terms of edge multiplicities, see \cite[Prop. 3.47(ii)]{BP17}).
...
We next recall the category $\Omega_G$ of $G$-trees first defined in \cite[\S 5.3]{Per17}. We start with an explicit example of a $G$-tree (for more examples, see \cite[\S 4.3]{Per17}).
