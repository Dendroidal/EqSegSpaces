...
\todo[inline]{is this still needed? Combine with description of $G U$.}
\begin{lemma}
      \label{FOF_OHORN_LEM}
...
\begin{proof}
      ...
      both $I$ and ${U_i}$ the poset $(\Lambda^{E}[T] \setminus \Lambda^{E}_o[T]) \cap \mathsf{Face}^{lex}_{E}(T)$, and
      \begin{equation}
            \qquad X = \Lambda^{E}_o[T],
            \qquad \set{\Ksi^i} = \set{U_i \cap E}.
      \end{equation}
      ...
      For (Ch1),
      \todo[inline]{come back: not $V \cap E$, but $E^i(V) \cap E$.}
      let $V$ be an outer face of some $U_i$, such that $\Ksi^i_V = V \cap E = \varnothing$.
      If $U_i$ is an outer face,
      $V_0$ has a minimal orbital outer face $G V_0$ also intersecting $E$ trivially,
      and hence both $G V_0$ and $V_0$ are in $\Lambda^E_o[T] = X \subseteq X_{< i}$.
      If $U_i$ is an inner face, 
      Lemma \ref{INNINT LEM} implies that $E^i(V) = E^i(U_i) \cap E^i(\bar V)$, and hence,
      since $U_i \cap E$ is maximal and by hypothesis $V \cap E = \varnothing$,
      we must have $\bar V \cap E = \varnothing$.
      Thus again we may conclude $V \in X$.
      For (Ch3),
