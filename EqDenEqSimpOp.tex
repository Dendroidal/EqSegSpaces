...
\begin{proof}
	...
	For (ii), note first that $X$ is simplicial fibrant iff for 	any monomorphism $K \to L$ in $\mathsf{sSet}$
the map
$X^L \to X^K$ is a fibration in $\mathsf{dSet}^G$. 
...
For (iii), one first notes that $X$ is dendroidal fibrant iff for any normal monomorphism $A \to B$ in $\mathsf{dSet}^G$
the map $X^B \to X^A$ is a Kan fibration in $\mathsf{sSet}$.
...
\begin{remark}
	Note that simplicial replacement after dendroidal replacement works but not vice versa.
	Example, $X^{(\Delta_{\bullet})} \to X^{\Delta_{\bullet}}$.
\end{remark}
