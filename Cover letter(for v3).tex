...
\item in ``Minor changes'', we list fixed typos and other small corrections. % made in response to errors which did not appear to affect the referee's understanding.
\end{itemize}
