...
\begin{proof}
      ...
      %   This follows by observing $\partial^{out}\Omega[T] \subseteq A$ and by applying \cref{FOF_OHORN_THM}, using the fact that any inner face of $T_0$ is not contained in any outer face.
      %   } % ---------------------------------------------------------------------------------------------
      ...
      % (Ch 2) again follows from \cref{FOF_OHORN_THM}.
\end{proof}
...
\end{proof}
\todo[inline]{Should have another proof using induction and the full strength of CHAREDGE LEM}
